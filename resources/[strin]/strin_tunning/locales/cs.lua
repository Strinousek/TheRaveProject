return {
	...
	["already_own"] = "Uz mate zakoupene: ~b~",
	["not_enough_money"] = "nemate dostatek penez!",
	["purchased"] = "zakoupil jste si vylepseni na vozidlo!",
	["press_custom"] = "Stiskni ~INPUT_PICKUP~ a uprav si svoje vozidlo.",
	["level"] = "level ",*/
	["neon"] = "neon",
-- Paint Colors
	-- Black
...
-- Upgrades
	...
	["no_turbo"] = "NO TURBO",
-- Cosmetics
	["cosmetics"] = "Vylepšení - Kosmetické",
	-- Body Parts
	["bodyparts"] = "Karoserie",
