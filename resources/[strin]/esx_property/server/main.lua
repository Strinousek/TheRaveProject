...
ESX.RegisterServerCallback("esx_property:buyProperty", function(source, cb, PropertyId)
  ...
  if xPlayer.getAccount("bank").money >= Price then
    ...
    Properties[PropertyId].OwnerName = xPlayer.get("fullname")
    ...
    if Config.OxInventory then
      exports.ox_inventory:RegisterStash("property-" .. PropertyId, Properties[PropertyId].Name, 15, 100000, xPlayer.identifier..":"..xPlayer.get("char_id"))
    end
  end
...
ESX.RegisterServerCallback("esx_property:attemptSellToPlayer", function(source, cb, PropertyId, PlayerId)
  ...
  if xTarget and (xTarget.getAccount("bank").money >= Price) and (xPlayer.job.name == PM.job) then
    ...
    Properties[PropertyId].Owner = xTarget.identifier..xTarget.get("char_id")
    Properties[PropertyId].OwnerName = xTarget.get("fullname")
    Properties[PropertyId].Owned = true
    ...
    TriggerClientEvent("esx_property:syncProperties", -1, Properties)
    if Config.OxInventory then
      exports.ox_inventory:RegisterStash("property-" .. PropertyId, Properties[PropertyId].Name, 15, 100000, xTarget.identifier..":"..xTarget.get("char_id"))
    end
    if PM.Enabled then
...
ESX.RegisterServerCallback("esx_property:buyFurniture", function(source, cb, PropertyId, PropName, PropIndex, PropCatagory, pos, heading)
  ...
  if (xPlayer.identifier..":"..xPlayer.get("char_id")) == Owner or IsPlayerAdmin(source) or (Properties[PropertyId].Keys and Properties[PropertyId].Keys[xPlayer.identifier..":"..xPlayer.get("char_id")]) then
  ...
  Log("Furniture Bought", 3640511,
    {{name = "**Property Name**", value = Properties[PropertyId].Name, inline = true},
     {name = "**Player**", value = xPlayer.getName(), inline = true}, {name = "**Has Access**",
                                                                       value = ((xPlayer.identifier..":"..xPlayer.get("char_id")) == Owner or IsPlayerAdmin(source) or
      (Properties[PropertyId].Keys and Properties[PropertyId].Keys[xPlayer.identifier..":"..xPlayer.get("char_id")])) and "Yes" or "No", inline = true},
...
ESX.RegisterServerCallback("esx_property:sellProperty", function(source, cb, PropertyId)
  local xPlayer = ESX.GetPlayerFromId(source)
  local Owner = Properties[PropertyId].Owner
  if (xPlayer.identifier..":"..xPlayer.get("char_id")) == Owner then
  ...
  cb((xPlayer.identifier..":"..xPlayer.get("char_id")) == Owner)
end)
...
ESX.RegisterServerCallback("esx_property:toggleLock", function(source, cb, PropertyId)
  local xPlayer = ESX.GetPlayerFromId(source)
  local Owner = Properties[PropertyId].Owner
  if (xPlayer.identifier..":"..xPlayer.get("char_id")) == Owner or IsPlayerAdmin(source, "ToggleLock") or
    (Properties[PropertyId].Keys and Properties[PropertyId].Keys[xPlayer.identifier..":"..xPlayer.get("char_id")]) then
  ...
  cb(xPlayer.identifier == Owner or IsPlayerAdmin(source, "ToggleLock") or
       (Properties[PropertyId].Keys and Properties[PropertyId].Keys[xPlayer.identifier..":"..xPlayer.get("char_id")]))
end)
...
ESX.RegisterServerCallback("esx_property:CCTV", function(source, cb, PropertyId)
  ...
  cb((xPlayer.identifier..":"..xPlayer.get("char_id")) == Owner or IsPlayerAdmin(source) or (Properties[PropertyId].Keys and Properties[PropertyId].Keys[xPlayer.identifier..":"..xPlayer.get("char_id")]))
end)
...
ESX.RegisterServerCallback("esx_property:SetPropertyName", function(source, cb, PropertyId, name)
  ...
  local Owner = Properties[PropertyId].Owner
  local Property = Properties[PropertyId]
  if (xPlayer.identifier..":"..xPlayer.get("char_id")) == Owner or IsPlayerAdmin(source) then
  ...
  cb(((xPlayer.identifier..":"..xPlayer.get("char_id")) == Owner or IsPlayerAdmin(source, "SetPropertyName")) and name and #name <= Config.MaxNameLength)
end)

ESX.RegisterServerCallback("esx_property:KnockOnDoor", function(source, cb, PropertyId, name)
  local xPlayer = ESX.GetPlayerFromId(source)
  local Property = Properties[PropertyId]
  local identifier = Property.Owner:sub(1, Property.Owner:find(":") - 1)
...
/*ESX.RegisterServerCallback("esx_property:RemoveAllfurniture", function(source, cb, PropertyId)
  local xPlayer = ESX.GetPlayerFromId(source)
  local Owner = Properties[PropertyId].Owner
  if (xPlayer.identifier..":"..xPlayer.get("char_id")) == Owner or IsPlayerAdmin(source, "ResetFurniture") or
    (Properties[PropertyId].Keys and Properties[PropertyId].Keys[xPlayer.identifier..":"..xPlayer.get("char_id")]) then
    for i = 1, #Properties[PropertyId].plysinside do
...
ESX.RegisterServerCallback("esx_property:deleteFurniture", function(source, cb, PropertyId, furnitureIndex)
  ...
  cb(xPlayer.identifier == Owner or IsPlayerAdmin(source) or (Properties[PropertyId].Keys and Properties[PropertyId].Keys[xPlayer.identifier..":"..xPlayer.get("char_id")]))
end)
...
ESX.RegisterServerCallback("esx_property:evictOwner", function(source, cb, PropertyId, Interior)
  ...
  if IsPlayerAdmin(source, "EvictOwner") then
    local Property = Properties[PropertyId]
    local identifier = Property.Owner:sub(1, Property.Owner:find(":") - 1)
    local xOwner = ESX.GetPlayerFromIdentifier(identifier)
    if xOwner then
...
ESX.RegisterServerCallback("esx_property:SetInventoryPosition", function(source, cb, PropertyId, Coords, Reset)
  if Config.OxInventory then
    local Property = Properties[PropertyId]
    local xPlayer = ESX.GetPlayerFromId(source)
    if IsPlayerAdmin(source, "EditInteriorPositions") or (Property.Owner == (xPlayer.identifier..":"..xPlayer.get("char_id")) or Properties[PropertyId].Keys[xPlayer.identifier..":"..xPlayer.get("char_id")]) then
      local Interior = GetInteriorValues(Property.Interior)
      if Reset then
      ...
      Log("Property Storage Location Set", 3640511,
        {{name = "**Property Name**", value = Property.Name, inline = true}, {name = "**Owner**", value = Property.OwnerName, inline = true},
         {name = "**Player**", value = xPlayer.getName(), inline = true}, {name = "**Has Access**",
          ...
          (Property.Owner == (xPlayer.identifier..":"..xPlayer.get("char_id")) or Properties[PropertyId].Keys[xPlayer.identifier..":"..xPlayer.get("char_id")])) and "Yes" or "No", inline = true},
         {name = "**Reset?**", value = Reset and "Yes" or "No", inline = true}}, 1)
      TriggerClientEvent("esx_property:syncProperties", -1, Properties)
    end
    cb(IsPlayerAdmin(source, "EditInteriorPositions") or (Property.Owner == (xPlayer.identifier..":"..xPlayer.get("char_id")) or Properties[PropertyId].Keys[xPlayer.identifier..":"..xPlayer.get("char_id")]))
  else
    cb(false)
  end
end)
    ...
    if Reset then
      ...
      Log("Property Wardrobe Location Set", 3640511,
        {{name = "**Property Name**", value = Property.Name, inline = true}, {name = "**Owner**", value = Property.OwnerName, inline = true},
         {name = "**Player**", value = xPlayer.getName(), inline = true}, {name = "**Has Access**",
                                                                           value = (IsPlayerAdmin(source, "EditInteriorPositions") or
          (Property.Owner == xPlayer.identifier or Properties[PropertyId].Keys[xPlayer.identifier..":"..xPlayer.get("char_id")])) and "Yes" or "No", inline = true},
         {name = "**Reset?**", value = Reset and "Yes" or "No", inline = true}}, 1)
    end
    TriggerClientEvent("esx_property:syncProperties", -1, Properties)
  end
...
ESX.RegisterServerCallback('esx_property:GetInsidePlayers', function(source, cb, property)
  ...
  for k, v in pairs(NearbyPlayers) do
    ...
    if (xPlayer.identifier..":"..xPlayer.get("char_id")) ~= Property.Owner and not Properties[property].Keys[xPlayer.identifier..":"..xPlayer.get("char_id")] then
...
ESX.RegisterServerCallback('esx_property:GetPlayersWithKeys', function(source, cb, property)
  ...
  local Players = {}
  local xPlayer = ESX.GetPlayerFromId(source)
  if (xPlayer.identifier..":"..xPlayer.get("char_id")) == Property.Owner then
    cb(Property.Keys or {})
  end
end)
...
ESX.RegisterServerCallback('esx_property:ShouldHaveKey', function(source, cb, property)
  local xPlayer = ESX.GetPlayerFromId(source)
  cb(Properties[property].Keys[xPlayer.identifier..":"..xPlayer.get("char_id")])
end)
...
ESX.RegisterServerCallback('esx_property:GiveKey', function(source, cb, property, player)
  ...
  if Property.Owner == (xPlayer.identifier..":"..xPlayer.get("char_id")) then
    if not Property.Keys then
      Properties[property].Keys = {}
    end

    local id = xTarget.identifier..":"..xTarget.get("char_id")
  ...
  Log("Property Key Given", 3640511,
    {{name = "**Property Name**", value = Property.Name, inline = true}, {name = "**Owner**", value = Property.OwnerName, inline = true},
     ...
     {name = "**Has Access**", value = Property.Owner == (xPlayer.identifier..":"..xPlayer.get("char_id")) and "Yes" or "No", inline = true}}, 1)
end)
...
ESX.RegisterServerCallback('esx_property:CanOpenFurniture', function(source, cb, property)
  local xPlayer = ESX.GetPlayerFromId(source)
  local Property = Properties[property]
  cb(Property.Owner == (xPlayer.identifier..":"..xPlayer.get("char_id")) or (Property.Keys and Properties[property].Keys[xPlayer.identifier..":"..xPlayer.get("char_id")]))
end)
