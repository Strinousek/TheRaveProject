...
if Config.EnableXtoCancel then
    RegisterKeyMapping("emotecancel", "<FONT FACE='Righteous'>Zruší animaci z animačního menu~</FONT>", "keyboard", Config.CancelEmoteKey)
end
...
Citizen.CreateThread(function()
    TriggerEvent('chat:addSuggestion', '/e', 'Spuštění animace',
        { { name = "emotename", help = "dance, camera, sit nebo jakákoliv jiná animace." },
            { name = "texturevariation", help = "(Volitelné) 1, 2, 3 nebo jakékoliv jiné číslo. Změní variaci textůry propu." } })
    TriggerEvent('chat:addSuggestion', '/emote', 'Spuštění animace',
        { { name = "emotename", help = "dance, camera, sit nebo jakákoliv jiná animace." },
            { name = "texturevariation", help = "(Volitelné) 1, 2, 3 nebo jakékoliv jiné číslo. Změní variaci textůry propu." } })
    ...
    TriggerEvent('chat:addSuggestion', '/emotemenu', 'Otevření animačního menu.')
    TriggerEvent('chat:addSuggestion', '/emotes', 'Seznam dostupných animací.')
    TriggerEvent('chat:addSuggestion', '/emotecancel', 'Stopnutí animace.')
    TriggerEvent('chat:addSuggestion', '/handsup', 'Zvednout ruce.')
end)
...
if Config.MenuKeybindEnabled then
    ...
    RegisterKeyMapping("emoteui", "<FONT FACE='Righteous'>Otevřít animační menu~</FONT>", "keyboard", Config.MenuKeybind)
else
