...
Config = {
    ...
    MenuImage = "https://imgur.com/xs0XVBR.gif", ----[Custom banner IMGUR or GIPHY URLs go here ]---
    ...
    RagdollEnabled = true,
    RagdollKeybind = 'OEM_1', -- Get the button string here https://docs.fivem.net/docs/game-references/input-mapper-parameter-ids/keyboard/
