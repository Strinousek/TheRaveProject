Config.Languages = {
    ...
    ['cs'] = { -- Czech 🇨🇿
        ['emotes'] = 'Animace ',
        ['danceemotes'] = "🕺 Tanecni animace",
        ['animalemotes'] = "🐩 Zvireci animace",
        ['propemotes'] = "📦 Animace s predmety",
        ['favoriteemotes'] = "🌟 Oblibene",
        ['favoriteinfo'] = "Vyberte si animaci a nastavte ji jako svou oblibenou.",
        ['rfavorite'] = "Obnovit oblibene",
        ['prop2info'] = "❓ Pomucky se mohou nachazet na konci",
        ['set'] = "Nastavit",
        ['setboundemote'] = "Nastavit jako vasi animaci?",
        ['newsetemote'] = "~w~ je nyni vasi novou nastavenou animaci. Chcete-li jej pouzit, stisknete ~g~CapsLock~w~.",
        ['cancelemote'] = "Zrusit animaci 🚷",
        ['cancelemoteinfo'] = "~r~X~w~ Zrusi aktualne prehravanou animaci",
        ['walkingstyles'] = "Styly chuze 🚶🏻‍♂️",
        ['resetdef'] = "Obnovit do zakladniho nastaveni",
        ['normalreset'] = "Neutralni vyraz",
        ['moods'] = "Vyrazy 😒",
        ['infoupdate'] = "Kredity a napady 🙏🏻",
        ['infoupdateav'] = "Informace (aktualizace dostupna)",
        ['infoupdateavtext'] = "Je k dispozici aktualizace, stahnete si nejnovejsi verzi z ~y~https://github.com/TayMcKenzieNZ/rpemotes~w~",
        ['suggestions'] = "Napady?",
        ['suggestionsinfo'] = "~r~TayMcKenzieNZ~s~ na FiveM forums je pro jakykoliv navrh! ✉️",
        ['notvaliddance'] = "Neni platny tanec.",
        ['notvalidemote'] = "Neni platna animace.",
        ['nocancel'] = "Zadne animace ke zruseni.",
        ['maleonly'] = "Tato emoce je pouze pro muze, omlouvam se!",
        ['emotemenucmd'] = "Pouzij /emotemenu pro otevreni menu.",
        ['shareemotes'] = "👫 Sdilene animace",
        ['shareemotesinfo'] = "Pozvete osobu v okoli, k tanci",
        ['sharedanceemotes'] = "🕺 Sdileny tanece",
        ['notvalidsharedemote'] = "Neni platny Sdileny tanec.",
        ['sentrequestto'] = "Odeslal jsi ~y~ zadost o tanec ",
        ['nobodyclose'] = "Nikdo ~r~neni~w~ v dostatecne blizkosti.",
        ['doyouwanna'] = "~y~Y~w~ pro prijmuti, ~r~L~w~ pro odmitnuti (~g~",
        ['refuseemote'] = "Emote odmitnut.",
        ['makenearby'] = "nechat hrace pobliz hrat",
        ['useleafblower'] = "Stisknete ~y~G~w~ pro pouziti foukace listi",
        ['camera'] = "Stiskni ~y~G~w~ pro pouziti blesku.",
        ['makeitrain'] = "Stiskni ~y~G~w~ pro spusteni deste.",
        ['pee'] = "Podrz ~y~G~w~ pro curani.",
        ['spraychamp'] = "Podrz ~y~G~w~ pro strikani sampanskeho",
        ['stun'] = "Stiskni ~y~G~w~ pro 'pouziti' taseru.",
        ['vape'] = "Stiskni ~y~G~w~ pro 'pouziti' vape.",
        ['bound'] = "Bound ",
        ['to'] = "na",
        ['currentlyboundemotes'] = "Momentalne nastavene animace:",
        ['notvalidkey'] = "Neni platna klavesa.",
        ['keybinds'] = "🔢 Klavesove Zkratky",
        ['keybindsinfo'] = "Use",
        ['searchemotes'] = "🔍 Vyhledat animace",
        ['searchinputtitle'] = "Vyhledano:",
        ['searchmenudesc'] = "%s vysledek pro '~r~%s~w~':",
        ['searchnoresult'] = "zadna animace nebyla nalezena '~r~%s~w~'.",
        ['searchshifttofav'] = "Podrz L-Shift a stiskni enter pro nastaveni animace do oblibenich.",
        ['searchcantsetfav'] = "Sdilene animace nelze nastavit jako oblibene.",
        ['invalidvariation'] = "Neplatna variace textury. Platne vybery jsou: %s",
        ['firework'] = "Stiskni ~y~G~w~ pro pouziti ohnostroje",
        ['poop'] = "Stisknutim ~y~G~w~ se vykakate",
        ['puke'] = "Stiskni ~y~G~w~ pro zvraceni",
        ['btn_select'] = "Vybrat",
        ['btn_back'] = "Zpet",
        ['btn_switch'] = "Pohyb",
        ['btn_increment'] = "Increment",
        ['dead'] = "Nemuzes pouzit animace, kdyz jste mrtev!",
        ['swimming'] = "You can't use emotes while swimming",
        ['notvalidpet'] = "Ohh! Zjisten nespravny model peda! 🐕",
        ['animaldisabled'] = "Omlouvame se! Zvireci emotikony jsou na tomto serveru zakazany",
        ['adultemotedisabled'] = "Bonk! Dospele emotikony vypnuty 🔞",
        ['toggle_instructions'] = "Toggle the instructions",
        ['exit_binoculars'] = "Vystup z dalekohledu",
        ['toggle_binoculars_vision'] = "Prepinani mezi rezimy videni",
        ['exit_news'] = "Vystup ze zpravodajske kamery",
        ['toggle_news_vision'] = "Prepinani mezi rezimy videni",
        ['edit_values_newscam'] = "uprava textu zpravy",
        ['not_in_a_vehicle'] = "Tuto animaci nelze prehravat ve vozidle.",
        ['in_a_vehicle'] = "Tuto animaci lze prehrat pouze ve vozidle.",
        ['no_anim_crawling'] = "Pri plazeni nelze prehravat animace"
    },
    ['da'] = { -- Danish 🇩🇰
        ['emotes'] = 'Animationer',
