...
local DefaultModelLoaded = false 
local Character		= {}
...
function ApplySkin(skin, clothes, changedPieces)
	/*
	...
	*/
	...
	if(not changedPieces or (changedPieces and (lib.table.contains(changedPieces, "mom") or lib.table.contains(changedPieces, "dad")))) then
	...
	if(not changedPieces or (changedPieces and (lib.table.contains(changedPieces, "nose_1")))) then
		SetPedFaceFeature			(playerPed,			0,								(Character['nose_1'] / 10) + 0.0)			-- Nose Width
	end

	if(not changedPieces or (changedPieces and (lib.table.contains(changedPieces, "nose_2")))) then
		SetPedFaceFeature			(playerPed,			1,								(Character['nose_2'] / 10) + 0.0)			-- Nose Peak Height
	end

	if(not changedPieces or (changedPieces and (lib.table.contains(changedPieces, "nose_3")))) then
		SetPedFaceFeature			(playerPed,			2,								(Character['nose_3'] / 10) + 0.0)			-- Nose Peak Length
	end

	if(not changedPieces or (changedPieces and (lib.table.contains(changedPieces, "nose_4")))) then
		SetPedFaceFeature			(playerPed,			3,								(Character['nose_4'] / 10) + 0.0)			-- Nose Bone Height
	end

	if(not changedPieces or (changedPieces and (lib.table.contains(changedPieces, "nose_5")))) then
		SetPedFaceFeature			(playerPed,			4,								(Character['nose_5'] / 10) + 0.0)			-- Nose Peak Lowering
	end
	
	if(not changedPieces or (changedPieces and (lib.table.contains(changedPieces, "nose_6")))) then
		SetPedFaceFeature			(playerPed,			5,								(Character['nose_6'] / 10) + 0.0)			-- Nose Bone Twist
	end
	
	if(not changedPieces or (changedPieces and (lib.table.contains(changedPieces, "eyebrows_5")))) then
		SetPedFaceFeature			(playerPed,			6,								(Character['eyebrows_5'] / 10) + 0.0)		-- Eyebrow height
	end
	
	if(not changedPieces or (changedPieces and (lib.table.contains(changedPieces, "eyebrows_6")))) then
		SetPedFaceFeature			(playerPed,			7,								(Character['eyebrows_6'] / 10) + 0.0)		-- Eyebrow depth
	end
	
	if(not changedPieces or (changedPieces and (lib.table.contains(changedPieces, "cheeks_1")))) then
		SetPedFaceFeature			(playerPed,			8,								(Character['cheeks_1'] / 10) + 0.0)			-- Cheekbones Height
	end
	
	if(not changedPieces or (changedPieces and (lib.table.contains(changedPieces, "cheeks_2")))) then
		SetPedFaceFeature			(playerPed,			9,								(Character['cheeks_2'] / 10) + 0.0)			-- Cheekbones Width
	end
	
	if(not changedPieces or (changedPieces and (lib.table.contains(changedPieces, "cheeks_3")))) then
		SetPedFaceFeature			(playerPed,			10,								(Character['cheeks_3'] / 10) + 0.0)			-- Cheeks Width
	end
	
	if(not changedPieces or (changedPieces and (lib.table.contains(changedPieces, "eye_squint")))) then
		SetPedFaceFeature			(playerPed,			11,								(Character['eye_squint'] / 10) + 0.0)		-- Eyes squint
	end
	
	if(not changedPieces or (changedPieces and (lib.table.contains(changedPieces, "lip_thickness")))) then
		SetPedFaceFeature			(playerPed,			12,								(Character['lip_thickness'] / 10) + 0.0)	-- Lip Fullness
	end
	
	if(not changedPieces or (changedPieces and (lib.table.contains(changedPieces, "jaw_1")))) then
		SetPedFaceFeature			(playerPed,			13,								(Character['jaw_1'] / 10) + 0.0)			-- Jaw Bone Width
	end
	
	if(not changedPieces or (changedPieces and (lib.table.contains(changedPieces, "jaw_2")))) then
		SetPedFaceFeature			(playerPed,			14,								(Character['jaw_2'] / 10) + 0.0)			-- Jaw Bone Length
	end
	
	if(not changedPieces or (changedPieces and (lib.table.contains(changedPieces, "chin_1")))) then
		SetPedFaceFeature			(playerPed,			15,								(Character['chin_1'] / 10) + 0.0)			-- Chin Height
	end
	
	if(not changedPieces or (changedPieces and (lib.table.contains(changedPieces, "chin_2")))) then
		SetPedFaceFeature			(playerPed,			16,								(Character['chin_2'] / 10) + 0.0)			-- Chin Length
	end
	
	if(not changedPieces or (changedPieces and (lib.table.contains(changedPieces, "chin_3")))) then
		SetPedFaceFeature			(playerPed,			17,								(Character['chin_3'] / 10) + 0.0)			-- Chin Width
	end

	if(not changedPieces or (changedPieces and (lib.table.contains(changedPieces, "chin_4")))) then
		SetPedFaceFeature			(playerPed,			18,								(Character['chin_4'] / 10) + 0.0)			-- Chin Hole Size
	end

	if(not changedPieces or (changedPieces and (lib.table.contains(changedPieces, "neck_thickness")))) then
		SetPedFaceFeature			(playerPed,			19,								(Character['neck_thickness'] / 10) + 0.0)	-- Neck Thickness
	end

	if(not changedPieces or (changedPieces and (lib.table.contains(changedPieces, "hair_color_1") or lib.table.contains(changedPieces, "hair_color_2")))) then
		SetPedHairColor				(playerPed,			Character['hair_color_1'],		Character['hair_color_2'])					-- Hair Color													
	end
	
	if(not changedPieces or (changedPieces and (lib.table.contains(changedPieces, "age_1") or lib.table.contains(changedPieces, "age_2")))) then
		SetPedHeadOverlay			(playerPed, 3,		Character['age_1'],				(Character['age_2'] / 10) + 0.0)			-- Age + opacity													
	end
	
	if(not changedPieces or (changedPieces and (lib.table.contains(changedPieces, "blemishes_1") or lib.table.contains(changedPieces, "blemishes_2")))) then
		SetPedHeadOverlay			(playerPed, 0,		Character['blemishes_1'],		(Character['blemishes_2'] / 10) + 0.0)		-- Blemishes + opacity													
	end
	
	if(not changedPieces or (changedPieces and (lib.table.contains(changedPieces, "beard_1") or lib.table.contains(changedPieces, "beard_2")))) then
		SetPedHeadOverlay			(playerPed, 1,		Character['beard_1'],			(Character['beard_2'] / 10) + 0.0)			-- Beard + opacity													
	end
	
	if(not changedPieces or (changedPieces and (lib.table.contains(changedPieces, "eye_color")))) then
		SetPedEyeColor				(playerPed,			Character['eye_color'])														-- Eyes color													
	end
	
	if(not changedPieces or (changedPieces and (lib.table.contains(changedPieces, "eyebrows_1") or lib.table.contains(changedPieces, "eyebrows_2")))) then
		SetPedHeadOverlay			(playerPed, 2,		Character['eyebrows_1'],		(Character['eyebrows_2'] / 10) + 0.0)		-- Eyebrows + opacity													
	end
	
	if(not changedPieces or (changedPieces and (lib.table.contains(changedPieces, "makeup_1") or lib.table.contains(changedPieces, "makeup_2")))) then
		SetPedHeadOverlay			(playerPed, 4,		Character['makeup_1'],			(Character['makeup_2'] / 10) + 0.0)			-- Makeup + opacity													
	end
	
	if(not changedPieces or (changedPieces and (lib.table.contains(changedPieces, "lipstick_1") or lib.table.contains(changedPieces, "lipstick_2")))) then
		SetPedHeadOverlay			(playerPed, 8,		Character['lipstick_1'],		(Character['lipstick_2'] / 10) + 0.0)		-- Lipstick + opacity													
	end
	
	if(not changedPieces or (changedPieces and (lib.table.contains(changedPieces, "hair_1") or lib.table.contains(changedPieces, "hair_2")))) then
		SetPedComponentVariation	(playerPed, 2,		Character['hair_1'],			Character['hair_2'], 2)						-- Hair													
	end
	
	if(not changedPieces or (changedPieces and (lib.table.contains(changedPieces, "beard_3") or lib.table.contains(changedPieces, "beard_4")))) then
		SetPedHeadOverlayColor		(playerPed, 1, 1,	Character['beard_3'],			Character['beard_4'])						-- Beard Color													
	end
	
	if(not changedPieces or (changedPieces and (lib.table.contains(changedPieces, "eyebrows_3") or lib.table.contains(changedPieces, "eyebrows_4")))) then
		SetPedHeadOverlayColor		(playerPed, 2, 1,	Character['eyebrows_3'],		Character['eyebrows_4'])					-- Eyebrows Color													
	end
	
	if(not changedPieces or (changedPieces and (lib.table.contains(changedPieces, "makeup_3") or lib.table.contains(changedPieces, "makeup_4")))) then
		SetPedHeadOverlayColor		(playerPed, 4, 2,	Character['makeup_3'],			Character['makeup_4'])						-- Makeup Color													
	end
	
	if(not changedPieces or (changedPieces and (lib.table.contains(changedPieces, "lipstick_3") or lib.table.contains(changedPieces, "lipstick_4")))) then
		SetPedHeadOverlayColor		(playerPed, 8, 1,	Character['lipstick_3'],		Character['lipstick_4'])					-- Lipstick Color												
	end
	
	if(not changedPieces or (changedPieces and (lib.table.contains(changedPieces, "blush_1") or lib.table.contains(changedPieces, "blush_2")))) then
		SetPedHeadOverlay			(playerPed, 5,		Character['blush_1'],			(Character['blush_2'] / 10) + 0.0)			-- Blush + opacity													
	end
	
	if(not changedPieces or (changedPieces and (lib.table.contains(changedPieces, "blush_3")))) then
		SetPedHeadOverlayColor		(playerPed, 5, 2,	Character['blush_3'])														-- Blush Color													
	end
	
	if(not changedPieces or (changedPieces and (lib.table.contains(changedPieces, "complexion_1") or lib.table.contains(changedPieces, "complexion_2")))) then
		SetPedHeadOverlay			(playerPed, 6,		Character['complexion_1'],		(Character['complexion_2'] / 10) + 0.0)		-- Complexion + opacity													
	end
	
	if(not changedPieces or (changedPieces and (lib.table.contains(changedPieces, "sun_1") or lib.table.contains(changedPieces, "sun_2")))) then
		SetPedHeadOverlay			(playerPed, 7,		Character['sun_1'],				(Character['sun_2'] / 10) + 0.0)			-- Sun Damage + opacity														
	end
	
	if(not changedPieces or (changedPieces and (lib.table.contains(changedPieces, "moles_1") or lib.table.contains(changedPieces, "moles_2")))) then
		SetPedHeadOverlay			(playerPed, 9,		Character['moles_1'],			(Character['moles_2'] / 10) + 0.0)			-- Moles/Freckles + opacity														
	end
	
	if(not changedPieces or (changedPieces and (lib.table.contains(changedPieces, "chest_1") or lib.table.contains(changedPieces, "chest_2")))) then
		SetPedHeadOverlay			(playerPed, 10,		Character['chest_1'],			(Character['chest_2'] / 10) + 0.0)			-- Chest Hair + opacity														
	end
	
	if(not changedPieces or (changedPieces and (lib.table.contains(changedPieces, "chest_3")))) then
		SetPedHeadOverlayColor		(playerPed, 10, 1,	Character['chest_3'])														-- Torso Color
	end

	if(not changedPieces or (changedPieces and (lib.table.contains(changedPieces, "bodyb_1") or lib.table.contains(changedPieces, "bodyb_2")))) then
	...
	if(not changedPieces or (changedPieces and (lib.table.contains(changedPieces, "bodyb_3") or lib.table.contains(changedPieces, "bodyb_4")))) then
	...
	if(not changedPieces or (changedPieces and (lib.table.contains(changedPieces, "ears_1") or lib.table.contains(changedPieces, "ears_2")))) then
	...
	if(not changedPieces or (changedPieces and (lib.table.contains(changedPieces, "tshirt_1") or lib.table.contains(changedPieces, "tshirt_2")))) then
		SetPedComponentVariation	(playerPed, 8,		Character['tshirt_1'],			Character['tshirt_2'], 2)					-- Tshirt¨
	end
	
	if(not changedPieces or (changedPieces and (lib.table.contains(changedPieces, "torso_1") or lib.table.contains(changedPieces, "torso_2")))) then
		SetPedComponentVariation	(playerPed, 11,		Character['torso_1'],			Character['torso_2'], 2)					-- torso parts
	end
	
	if(not changedPieces or (changedPieces and (lib.table.contains(changedPieces, "arms") or lib.table.contains(changedPieces, "arms_2")))) then
		SetPedComponentVariation	(playerPed, 3,		Character['arms'],				Character['arms_2'], 2)						-- Amrs
	end
	
	if(not changedPieces or (changedPieces and (lib.table.contains(changedPieces, "decals_1") or lib.table.contains(changedPieces, "decals_2")))) then
		SetPedComponentVariation	(playerPed, 10,		Character['decals_1'],			Character['decals_2'], 2)					-- decals
	end
	
	if(not changedPieces or (changedPieces and (lib.table.contains(changedPieces, "pants_1") or lib.table.contains(changedPieces, "pants_2")))) then
		SetPedComponentVariation	(playerPed, 4,		Character['pants_1'],			Character['pants_2'], 2)					-- pants
	end
	
	if(not changedPieces or (changedPieces and (lib.table.contains(changedPieces, "shoes_1") or lib.table.contains(changedPieces, "shoes_2")))) then
		SetPedComponentVariation	(playerPed, 6,		Character['shoes_1'],			Character['shoes_2'], 2)					-- shoes
	end
	
	if(not changedPieces or (changedPieces and (lib.table.contains(changedPieces, "mask_1") or lib.table.contains(changedPieces, "mask_2")))) then
		SetPedComponentVariation	(playerPed, 1,		Character['mask_1'],			Character['mask_2'], 2)						-- mask
	end
	
	if(not changedPieces or (changedPieces and (lib.table.contains(changedPieces, "bproof_1") or lib.table.contains(changedPieces, "bproof_2")))) then
		SetPedComponentVariation	(playerPed, 9,		Character['bproof_1'],			Character['bproof_2'], 2)					-- bulletproof
	end
	
	if(not changedPieces or (changedPieces and (lib.table.contains(changedPieces, "chain_1") or lib.table.contains(changedPieces, "chain_2")))) then
		SetPedComponentVariation	(playerPed, 7,		Character['chain_1'],			Character['chain_2'], 2)					-- chain
	end
	
	if(not changedPieces or (changedPieces and (lib.table.contains(changedPieces, "bags_1") or lib.table.contains(changedPieces, "bags_2")))) then
		SetPedComponentVariation	(playerPed, 5,		Character['bags_1'],			Character['bags_2'], 2)						-- Bag
	end

	
	if(not changedPieces or (changedPieces and (lib.table.contains(changedPieces, "helmet_1") or lib.table.contains(changedPieces, "helmet_2")))) then
	...
	if(not changedPieces or (changedPieces and (lib.table.contains(changedPieces, "glasses_1") or lib.table.contains(changedPieces, "glasses_2")))) then
	...
	if(not changedPieces or (changedPieces and (lib.table.contains(changedPieces, "watches_1") or lib.table.contains(changedPieces, "watches_2")))) then
	...
	if(not changedPieces or (changedPieces and (lib.table.contains(changedPieces, "bracelets_1") or lib.table.contains(changedPieces, "bracelets_2")))) then
...
function GetData()
	local components = lib.table.deepclone(Components)
...
lib.callback.register("skinchanger:getNetData", function()
	return GetData()
end)
...
function GetComponent(name)
	...
	component.max = maxValues[component.name]
	return component
end

lib.callback.register("skinchanger:getNetComponent", function(name)
	return GetComponent(name)
end)

AddEventHandler('skinchanger:getComponent', function(cb, name)
	cb(GetComponents(name))
end)
...
lib.callback.register("skinchanger:getNetComponents", function()
	return GetComponents()
end)

AddEventHandler('skinchanger:getComponents', function(cb)
	cb(GetComponents())
end)

exports("GetComponents", GetComponents)

lib.callback.register("skinchanger:getNetSkin", function()
	return Character
end)
