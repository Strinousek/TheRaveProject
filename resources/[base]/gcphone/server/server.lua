...
function getContacts(identifier, characterId)
    local result = MySQL.Sync.fetchAll("SELECT * FROM phone_users_contacts WHERE phone_users_contacts.identifier = @identifier and phone_users_contacts.char_id = @char_id", {
        ['@identifier'] = identifier,
        ["@char_id"] = characterId
    })
    return result
...
function addContact(source, identifier, number, display, characterId)
    local sourcePlayer = tonumber(source)
    MySQL.Async.insert("INSERT INTO phone_users_contacts (`identifier`, `char_id`, `number`,`display`) VALUES(@identifier, @char_id, @number, @display)", {
        ['@identifier'] = identifier,
        ["@char_id"] = characterId,
        ['@number'] = number,
        ['@display'] = display,
...
function deleteContact(source, identifier, id, characterId)
    local sourcePlayer = tonumber(source)
    MySQL.Sync.execute("DELETE FROM phone_users_contacts WHERE `identifier` = @identifier AND `id` = @id AND `char_id` = @char_id", {
        ['@identifier'] = identifier,
        ['@id'] = id,
        ["@char_id"] = characterId
    })
...
function deleteAllContact(identifier, characterId)
    MySQL.Sync.execute("DELETE FROM phone_users_contacts WHERE `identifier` = @identifier AND `char_id` = @char_id", {
        ['@identifier'] = identifier,
        ["@char_id"] = characterId
    })
end
...
AddEventHandler('gcPhone:addContact', function(display, phoneNumber)
    ...
    identifier = xPlayer.identifier
    addContact(sourcePlayer, identifier, phoneNumber, display, xPlayer.get("char_id"))
end)
...
AddEventHandler('gcPhone:deleteContact', function(id)
	...
	xPlayer = ESX.GetPlayerFromId(_source)
    identifier = xPlayer.identifier
    deleteContact(sourcePlayer, identifier, id, xPlayer.get("char_id"))
end)
...
AddEventHandler('gcPhone:deleteALL', function()
    ...
    identifier = xPlayer.identifier
    deleteAllMessage(identifier)
    deleteAllContact(identifier, xPlayer.get("char_id"))
...
--  OnLoad
--====================================================================================
AddEventHandler("strin_characters:characterSwitched", function(identifier, characterId)
	...
	getOrGeneratePhoneNumber(identifier, function (myPhoneNumber)
        ...
        TriggerClientEvent('gcPhone:contactList', sourcePlayer, getContacts(identifier, characterId))
        TriggerClientEvent('gcPhone:allMessage', sourcePlayer, getMessages(identifier))
...
AddEventHandler("strin_characters:characterDeleted", function(identifier, characterId)
    MySQL.query.await("DELETE FROM phone_users_contacts WHERE `identifier` = ? AND `char_id` = ?", {
        identifier,
        characterId
    })
end)
...
AddEventHandler('esx:playerLoaded',function(playerId, xPlayer)
	...
	getOrGeneratePhoneNumber(identifier, function (myPhoneNumber)
        ...
        TriggerClientEvent('gcPhone:myPhoneNumber', sourcePlayer, myPhoneNumber)
        TriggerClientEvent('gcPhone:contactList', sourcePlayer, getContacts(identifier, xPlayer.get("char_id")))
        TriggerClientEvent('gcPhone:allMessage', sourcePlayer, getMessages(identifier))
        TriggerClientEvent('gcPhone:getBourse', sourcePlayer, getBourse())
        sendHistoriqueCall(sourcePlayer, num)
    end)
